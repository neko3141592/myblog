...
export default async function PostPage(props: Props) {
    ...
    if (!post) {
        ...
        // post.body内のコードブロックをreact-syntax-highlighterでハイライト
        // 例: <pre><code class="language-js">...</code></pre>
        function renderBodyWithCodeBlocks(html: string): JSX.Element[] {
        ...
        return (
                <main className="container mx-auto p-4">
                        <section>
                                ...
                                <h1 className="text-3xl font-bold my-4 border-l-8 border-blue-500 pl-2 rounded-xs">{post.title}</h1>
